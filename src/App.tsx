...
const CodexContent = lazy(() => import('@/pages/CodexContent').then((m) => ({ default: m.CodexContent })))
      ...
      >
        <Suspense fallback={<Loading />}>
          <Routes>
            ...
            <Route path="/unit/:unitId/codex" element={<RequireLogin><CodexContent /></RequireLogin>} />
