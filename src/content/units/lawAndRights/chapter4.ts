 ...
 * 학습: 인권 보장의 모습, 기본권(평등·자유·참정·사회·청구권), 생활 속 인권 보장, 인권 보장 노력.
...
export const chapter4: ChapterDef = {
  ...
  problems: [
    ...
    },
    {
      ...
      statement: '교육을 받을 권리는 인권 보장의 한 모습이다.',
      answer: true,
    },
    ...
    },
    {
      ...
      statement: '공공장소에 점자블록이나 경사로(휠체어 길)를 두는 것은 인권을 보장하기 위한 노력이다.',
      answer: true,
    },
